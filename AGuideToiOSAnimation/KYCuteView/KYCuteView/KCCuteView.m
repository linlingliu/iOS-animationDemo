...
@interface KCCuteView()

@end

@implementation KCCuteView
...
-(void)handleDragGesture:(UIPanGestureRecognizer *)ges{CGPoint dragPoint = [ges locationInView:self.containerView];
